            ...
            <div class="card mb-5">
                <div class="card-body d-flex flex-column align-items-center" style="box-shadow: 0px 0px 20px rgb(66,71,77);"><img src="{{URL::asset('/imgs/logo.png')}}" width="156" height="105">
                    ...
                    <form class="text-center" method="post" action="{{ route("login") }}">
                        @csrf
                        <div class="mb-3"><input class="form-control form-control-lg" type="text" id="email" name="email" placeholder="Email" style="font-family: 'JetBrains Mono', monospace;"></div>
                        <div class="mb-3"><input class="form-control form-control-lg" type="password" id="password" name="password" placeholder="Jelszó" style="font-family: 'JetBrains Mono', monospace;"></div>
